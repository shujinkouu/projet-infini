...
def ex_insta():
    ...
    WebDriverWait(driver, 60).until(expected_conditions.presence_of_element_located((By.XPATH, "/html/body/div[1]/div/div/section/nav[2]/div/div/div[2]/div/div/div[3]")))    
...
"""
    ...
    #skipbtnxpath = "/html/body/div[1]/div/div/section/nav[2]/div/div/div[2]/div/div/div[3]"
    #print('1')
    skipbtn = driver.find_element_by_xpath(skipbtnxpath)
    print('2')
    skipbtn.click()
...
###<selenium.webdriver.firefox.webelement.FirefoxWebElement (session="8bc3a71f-8df4-4929-8a2e-8a1825e4f575", element="d017c0d5-42d2-415e-a1f9-02d50516641c")>
###>>> btn = driver.find_element_by_xpath(xpath)
###>>> btn.click()
###
###imagepath = askopenfilename()
###this is the module needed 
###it should be put in the initialization sequence
###from tkinter.filedialog import askopenfilename
###>>> keyboard.press(imagepath)
###
###
...
"""
oldxpath_toconnectbtn = "/html/body/div/div/div/div/main/div/div/div/div[1]/div/div[3]/a[2]/div/span/span"

"""

twitterdict = {
    "toconnectbtn_primary": "/html/body/div/div/div/div[2]/main/div/div/div[1]/div[1]/div/div[3]/div[5]/a/div/span/span",
    "toconnectbtn_secondary": "/html/body/div/div/div/div[2]/main/div/div/div[1]/div/div/div[1]/a/div",
    "emailfield": "/html/body/div/div/div/div[1]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div/div[5]/label/div/div[2]/div/input",
    "loginnxtbtn_login": "/html/body/div/div/div/div[1]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div/div[6]/div/span/span",
    "passfield": "/html/body/div/div/div/div[1]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div/div[3]/div/label/div/div[2]/div[1]/input",
    "loginnxtbtn_pass": "/html/body/div/div/div/div[1]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[2]/div/div[1]/div/span/span",
    "usrnamerequired": "/html/body/div/div/div/div[1]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[2]/div/div/div/div"
}
...
def inittwitter():
    ...
    #error code this now works correctly and skips the first error
    #This is not perfect and often refresh when not needed
    #The error is due to how we find out the info for some reason even tho it loads correctl the error message is ending p in the text of the page
    ...
    info = soup.text
    print(info)
    if info.find('Something went wrong, but don’t fret — let’s give it another shot.') != -1:
        driver.refresh()
        print('fail')
        

    #We need this same thing but to check two different xpath at the same time
    ...
    try:
        button = driver.find_element_by_xpath(twitterdict['toconnectbtn_primary'])
        button.click()
    except:
        button = driver.find_element_by_xpath(twitterdict['toconnectbtn_secondary'])
        button.click()
    return driver
...
def logintwitter(emailtwitter,passwordtwitter,driver):
    atwitter = driver.find_element_by_xpath(twitterdict['emailfield'])
    atwitter.send_keys(emailtwitter)
    nxtbtn = driver.find_element_by_xpath(twitterdict['loginnxtbtn_login'])
    nxtbtn.click()
    print('btn should be clicked')
    sleep(3)
    
    
    #This should be saved in the database, twitter requires phonenumber or username to check for weird pattern in connection behaviour
    #This works alright it needs to be conditionnal to the event tho
    usr = driver.switch_to.active_element
    usr.send_keys('shujinkou3')
    #! this doesn't work we need the right button for this step
    nxtbtn = driver.find_element_by_xpath(twitterdict['usrnamerequired'])
    nxtbtn.click()


    sleep(2)    
    btwitter = driver.find_element_by_xpath(twitterdict['passfield'])
    btwitter.send_keys(passwordtwitter)
    nxtbtn = driver.find_element_by_xpath(twitterdict['loginnxtbtn_pass'])
    nxtbtn.click()
    sleep(3)
    
    #second error code is now deprecated
...
def tweet(driver,msg):
    ...
    tweetbutton = driver.find_element_by_xpath('/html/body/div[1]/div/div/div[1]/div[2]/div/div/div/div/div/div[2]/div[2]/div/div/div/div[3]/div/div[1]/div/div/div/div/div[2]/div[3]/div/div/div[2]/div[4]/div/span')
    print('the element zhould be selected')
    tweetbutton.click()
...
def posttweet(driver):
    ...
    #This is where we are it stops working here and can't post !
...
def ex_tw():
    ...
    try:
        #print("logging in")
        logintwitter(emailtwitter,passwordtwitter,driver)
    except:
        try:
...
#I don't know what this is for but it doesn't seem to have anything to do with anything
