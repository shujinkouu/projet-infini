...
def Call_Variables(url_list):
  #print('yo my dude ')
  print(url_list)
  #url_list is accessible we now only need to use dl(url_list) to download the vids :)
  def dl(url_list):
    ...
    for n in url_list:
      try:
        ...
        print('url:'+n+' has failed downloading')
  dl(url_list)
...
class MyGrid(Widget):
    ...
    def btn(self):
        ...
        #Now we just need for the list to be cutting at the /n 
        print(var1)
...
class MyApp(App):
    ...
    def btn(self):
      ...
      #self.var = var1
      self.var = "your files are now downloaded"
