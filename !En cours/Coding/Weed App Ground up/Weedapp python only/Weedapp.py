...
#try:
extrapolN = input('\nDo you want to extrapol based on a custom value?\n[If yes give me your custom value]')
#except ValueError:
#  pass
#extrapol = 'y'
try:
  if float(extrapolN) != 0:
...
if extrapol == 'y':
  ...
  lenght = len(f)
  #print('lenght is equal to: ' + str(lenght))
...
#      print('Initial:\n' + str(InitialAmount) + str(InitialMonth) + str(InitialDay) + str(InitialYear) + '\n')
    ...
    if counter == lenght-1:
      ...
      Sevendaysago = d1 - dt.timedelta(days=7)
      print(Sevendaysago)
